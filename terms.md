...
By using Dash VPN, you agree to these terms.
...
When using Dash VPN, you agree to:

- Comply with all applicable laws in your jurisdiction
- Use the app only for lawful purposes
- Provide your own Outline server access keys
- Not use the app for any illegal activities

## No Warranty

Dash VPN is provided "as is" without warranty of any kind. We do not guarantee:

- Uninterrupted or error-free operation
- Compatibility with all Outline servers
- Any specific level of performance or speed
...
- The Outline servers you connect to
- The content you access through those servers
- Ensuring your server usage complies with applicable laws
